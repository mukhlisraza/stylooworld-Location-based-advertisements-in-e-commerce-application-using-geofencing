        ...
        <div class="container-login100">
            ...
            <div class="wrap-login100">
                <div class="login100-pic js-tilt" data-tilt>
                    <img src="images/ico/user_login.svg" alt="IMG">
                </div>

                <form class="login100-form validate-form" id="loginForm" action="{{url('/user-login')}}" method="post">
                    @csrf
                    ...
                    <div class="wrap-input100 validate-input" data-validate="Valid number is required: 030?,???????">
                        <input class="input100" type="number" name="phone" id="phone" placeholder="Phone no">
