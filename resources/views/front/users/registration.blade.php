        ...
        <div class="container-login100">
            <div class="wrap-login100">
                <div class="login100-pic js-tilt" data-tilt>
                    <img src="images/ico/registration.svg" alt="IMG">
                </div>

                <form class="login100-form validate-form" id="registerForm" action="{{url('/user-register')}}" method="post">
                    @csrf
                    ...
                    <div class="wrap-input100 validate-input" data-validate="Enter a valid name: characters only">
                        <input class="input100" type="text" name="name" id="name" placeholder="kirmaan">
                        <span class="focus-input100"></span>
                        <span class="symbol-input100">
                            <i class="fa fa-user" aria-hidden="true"></i>
                        </span>
                    </div>
                    <div class="wrap-input100 validate-input" data-validate="Valid number is required: 030?,???????">
                        <input class="input100" type="number" name="phone" id="phone" placeholder="03000000000">
                        <span class="focus-input100"></span>
                        <span class="symbol-input100">
